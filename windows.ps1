...
RunCommands @(
    ...
    "scoop install vscode vscode-insiders vscodium fnm sublime-text postman heidisql sourcetree ngrok android-studio android-clt mongodb mongodb-compass", # Coding
